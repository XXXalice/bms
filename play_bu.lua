...
local function main(keysNumber)
	...
	geo.note.original_scratch_w = 107
	...
	do
		...
		local f_w = 227
		append_all(skin.image, {
			{id = "judge_f_pg", src = "src_judge", x = 0, y = 0, w = f_w, h = 84, divy = 1, cycle = 120},
			{id = "judge_f_gr", src = "src_judge", x = 0, y = 252, w = f_w, h = 84, divy = 1, cycle = 80},
			{id = "judge_f_gd", src = "src_judge", x = 0, y = 420, w = f_w, h = 84, divy = 1, cycle = 80},
			{id = "judge_f_bd", src = "src_judge", x = 227, y = 420, w = f_w, h = 84, divy = 1, cycle = 80},
			{id = "judge_f_pr", src = "src_judge", x = 454, y = 420, w = f_w, h = 84, divy = 1, cycle = 80},
			{id = "judge_f_ms", src = "src_judge", x = 454, y = 420, w = f_w, h = 84, divy = 1, cycle = 80},
		})
		...
		append_all(skin.value, {
			{id = "judge_n_pg", src = "src_judge", x = 227, y = 0, w = n_total_w, h = 84, divx = 10, divy = 1, digit = 6, ref = 75, cycle = 120, space = num_space},
			{id = "judge_n_gr", src = "src_judge", x = 227, y = 252, w = n_total_w, h = 84, divx = 10, divy = 1, digit = 6, ref = 75, cycle = 80, space = num_space},
			{id = "judge_n_gd", src = "src_judge", x = 227, y = 252, w = n_total_w, h = 84, divx = 10, divy = 1, digit = 6, ref = 75, cycle = 80, space = num_space},
			{id = "judge_n_bd", src = "src_judge", x = 227, y = 252, w = n_total_w, h = 84, divx = 10, divy = 1, digit = 6, ref = 75, cycle = 80, space = num_space},
			{id = "judge_n_pr", src = "src_judge", x = 227, y = 252, w = n_total_w, h = 84, divx = 10, divy = 1, digit = 6, ref = 75, cycle = 80, space = num_space},
			{id = "judge_n_ms", src = "src_judge", x = 227, y = 252, w = n_total_w, h = 84, divx = 10, divy = 1, digit = 6, ref = 75, cycle = 80, space = num_space},
		})
